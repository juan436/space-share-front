...
import { authRepository, spaceRepository, reservationRepository, reviewRepository, adminRepository } from "./repositories";
...
export { authRepository, spaceRepository, reservationRepository, reviewRepository, adminRepository };
