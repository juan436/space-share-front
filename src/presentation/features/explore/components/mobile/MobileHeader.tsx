...
import { UserCircle2, LogIn, UserPlus, X } from "lucide-react";
    ...
    <div className="flex items-center justify-between px-4 py-3">
      ...
      <div className="relative" ref={menuRef}>
        <button
          ...
          className="relative flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-primary/10 to-accent/10 border border-border/50 transition-all active:scale-95"
