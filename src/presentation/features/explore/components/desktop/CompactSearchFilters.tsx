...
export function CompactSearchFilters({
  ...
  return (
    <div className="flex items-center gap-0 bg-white border border-border rounded-full shadow-sm overflow-hidden h-12 w-full max-w-2xl">
      ...
      <Select value={spaceType} onValueChange={onSpaceTypeChange}>
        <SelectTrigger className="h-12 bg-transparent border-none shadow-none text-xs font-medium text-foreground hover:bg-muted/40 rounded-none transition-colors gap-1 px-2 w-auto max-w-[136px] focus:ring-0 focus:ring-offset-0 [&>svg:last-child]:hidden">
