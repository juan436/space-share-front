...
export function AdminAnalytics() {
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Estadísticas de la plataforma</p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Analíticas</h1>
        <p className="text-sm text-muted-foreground">Estadísticas detalladas de la plataforma</p>
      </div>
